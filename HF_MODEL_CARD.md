...
**Input Features**: 11 engineered features (speed, altitude, gender + temporal features)  
...
**Dataset**: Endomondo HR (filtered for quality)  
**Samples**: 974 running workouts  
**Source**: Public Endomondo dataset  
**Preprocessing**: Quality filtering, outlier removal, feature engineering
...
The model expects 11 features per timestep:
...
features = torch.randn(1, 500, 11)  # [batch=1, seq_len=500, features=11]
...
```
Input: [batch, seq_len=500, features=11]
  ↓
